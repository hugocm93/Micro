...
;BracoRobotico.c,86 :: 		void main()
;BracoRobotico.c,91 :: 		char delimiter[] = "end";
	MOVLW       101
...
;BracoRobotico.c,99 :: 		ADCON1 = 0x06;
	MOVLW       6
	MOVWF       ADCON1+0 
;BracoRobotico.c,100 :: 		trisd = 0;
	CLRF        TRISD+0 
;BracoRobotico.c,101 :: 		portd = 0;
	CLRF        PORTD+0 
;BracoRobotico.c,111 :: 		ServoInit();
	CALL        _ServoInit+0, 0
;BracoRobotico.c,112 :: 		Delay_ms(200);
	MOVLW       3
	MOVWF       R11, 0
	MOVLW       8
	MOVWF       R12, 0
...
;BracoRobotico.c,114 :: 		ServoAttach(SHOULDER, &PORTD, SHOULDER);
	...
	CALL        _ServoAttach+0, 0
;BracoRobotico.c,115 :: 		ServoAttach(ELBOW, &PORTD, ELBOW);
	MOVLW       2
	MOVWF       FARG_ServoAttach_servo+0 
	MOVLW       PORTD+0
	MOVWF       FARG_ServoAttach_out+0 
	...
	MOVWF       FARG_ServoAttach_pin+0 
	CALL        _ServoAttach+0, 0
;BracoRobotico.c,116 :: 		ServoAttach(GRIPPER, &PORTD, GRIPPER);
	MOVLW       3
	MOVWF       FARG_ServoAttach_servo+0 
	MOVLW       PORTD+0
	MOVWF       FARG_ServoAttach_out+0 
	...
	MOVWF       FARG_ServoAttach_pin+0 
	CALL        _ServoAttach+0, 0
;BracoRobotico.c,119 :: 		setServoAngle(BASE, anglesMatrix[0][BASE]);
...
;BracoRobotico.c,120 :: 		setServoAngle(SHOULDER, anglesMatrix[0][SHOULDER]);
	MOVLW       1
	...
	MOVWF       FARG_setServoAngle_angle+3 
	CALL        _setServoAngle+0, 0
;BracoRobotico.c,121 :: 		setServoAngle(ELBOW, anglesMatrix[0][ELBOW]);
	MOVLW       2
	MOVWF       FARG_setServoAngle_id+0 
	MOVLW       0
	MOVWF       FARG_setServoAngle_id+1 
	...
	MOVWF       FARG_setServoAngle_angle+3 
	CALL        _setServoAngle+0, 0
;BracoRobotico.c,125 :: 		UART1_Init(57600);
	MOVLW       8
	MOVWF       SPBRG+0 
	BSF         TXSTA+0, 2, 0
	CALL        _UART1_Init+0, 0
;BracoRobotico.c,126 :: 		Delay_ms(200);
	MOVLW       3
	MOVWF       R11, 0
	MOVLW       8
	MOVWF       R12, 0
...
L_main1:
	...
	DECFSZ      R11, 1, 1
	BRA         L_main1
;BracoRobotico.c,127 :: 		writeStr("Start:");
	MOVLW       ?lstr1_BracoRobotico+0
	MOVWF       FARG_writeStr_str+0 
	MOVLW       hi_addr(?lstr1_BracoRobotico+0)
	MOVWF       FARG_writeStr_str+1 
	CALL        _writeStr+0, 0
;BracoRobotico.c,128 :: 		while(TRUE)
L_main2:
;BracoRobotico.c,130 :: 		if(!UART1_Data_Ready())
	CALL        _UART1_Data_Ready+0, 0
	MOVF        R0, 1 
	BTFSS       STATUS+0, 2 
	GOTO        L_main4
;BracoRobotico.c,132 :: 		continue;
	GOTO        L_main2
;BracoRobotico.c,133 :: 		}
L_main4:
;BracoRobotico.c,135 :: 		UART1_Read_Text(input, delimiter, ATTEMPTS);
...
;BracoRobotico.c,136 :: 		numberOfCommandsRead = parser(input, commands, params);
	MOVLW       main_input_L0+0
...
;BracoRobotico.c,138 :: 		for(i = 0; i < numberOfCommandsRead; i++)
	CLRF        main_i_L0+0 
	CLRF        main_i_L0+1 
L_main5:
	MOVLW       128
...
L__main41:
	BTFSC       STATUS+0, 0 
	GOTO        L_main6
;BracoRobotico.c,140 :: 		switch(commands[i])
	MOVLW       main_commands_L0+0
	ADDWF       main_i_L0+0, 0 
	MOVWF       FLOC__main+0 
	MOVLW       hi_addr(main_commands_L0+0)
	...
	MOVWF       FLOC__main+1 
	GOTO        L_main8
;BracoRobotico.c,142 :: 		case 'b': case 'B':
L_main10:
L_main11:
;BracoRobotico.c,143 :: 		setServoAngle(BASE, params[i]);
	CLRF        FARG_setServoAngle_id+0 
	CLRF        FARG_setServoAngle_id+1 
	MOVF        main_i_L0+0, 0 
	MOVWF       R0 
	...
	MOVWF       FARG_setServoAngle_angle+3 
	CALL        _setServoAngle+0, 0
;BracoRobotico.c,144 :: 		writeStr("write to base");
...
;BracoRobotico.c,145 :: 		break;
	GOTO        L_main9
;BracoRobotico.c,147 :: 		case 'o': case 'O':
L_main12:
L_main13:
;BracoRobotico.c,148 :: 		setServoAngle(SHOULDER, params[i]);
	MOVLW       1
	MOVWF       FARG_setServoAngle_id+0 
	MOVLW       0
	MOVWF       FARG_setServoAngle_id+1 
	...
	MOVWF       FARG_setServoAngle_angle+3 
	CALL        _setServoAngle+0, 0
;BracoRobotico.c,149 :: 		writeStr("write to shoulder");
	MOVLW       ?lstr3_BracoRobotico+0
	MOVWF       FARG_writeStr_str+0 
	MOVLW       hi_addr(?lstr3_BracoRobotico+0)
	MOVWF       FARG_writeStr_str+1 
	CALL        _writeStr+0, 0
;BracoRobotico.c,150 :: 		break;
	GOTO        L_main9
;BracoRobotico.c,152 :: 		case 'c': case 'C':
L_main14:
L_main15:
;BracoRobotico.c,153 :: 		setServoAngle(ELBOW, params[i]);
	MOVLW       2
	MOVWF       FARG_setServoAngle_id+0 
	MOVLW       0
	MOVWF       FARG_setServoAngle_id+1 
	...
	MOVWF       FARG_setServoAngle_angle+3 
	CALL        _setServoAngle+0, 0
;BracoRobotico.c,154 :: 		writeStr("write to elbow");
	MOVLW       ?lstr4_BracoRobotico+0
	MOVWF       FARG_writeStr_str+0 
	MOVLW       hi_addr(?lstr4_BracoRobotico+0)
	MOVWF       FARG_writeStr_str+1 
	CALL        _writeStr+0, 0
;BracoRobotico.c,155 :: 		break;
	GOTO        L_main9
;BracoRobotico.c,157 :: 		case 'p': case 'P':
L_main16:
L_main17:
;BracoRobotico.c,159 :: 		int pos = (int)params[i] >= 0 && (int)params[i] < POSITIONS ? (int)params[i] : 0;
	MOVF        main_i_L0+0, 0 
	MOVWF       R0 
	MOVF        main_i_L0+1, 0 
	MOVWF       R1 
...
L_main21:
	...
	MOVWF       main_pos_L4+1 
;BracoRobotico.c,160 :: 		writeStr("begin moving to position");
	MOVLW       ?lstr5_BracoRobotico+0
	MOVWF       FARG_writeStr_str+0 
	MOVLW       hi_addr(?lstr5_BracoRobotico+0)
	MOVWF       FARG_writeStr_str+1 
	CALL        _writeStr+0, 0
;BracoRobotico.c,161 :: 		setServosPosition(pos);
...
;BracoRobotico.c,162 :: 		writeStr("end moving to position");
	MOVLW       ?lstr6_BracoRobotico+0
	MOVWF       FARG_writeStr_str+0 
	MOVLW       hi_addr(?lstr6_BracoRobotico+0)
	MOVWF       FARG_writeStr_str+1 
	CALL        _writeStr+0, 0
;BracoRobotico.c,164 :: 		break;
	GOTO        L_main9
;BracoRobotico.c,166 :: 		case 'g': case 'G':
L_main22:
L_main23:
;BracoRobotico.c,174 :: 		float gripperAngle = (int)params[i] ? servos[GRIPPER].max : servos[GRIPPER].min;
	MOVF        main_i_L0+0, 0 
	MOVWF       R0 
	MOVF        main_i_L0+1, 0 
	MOVWF       R1 
...
;BracoRobotico.c,175 :: 		setServoAngle(GRIPPER, gripperAngle);
	MOVLW       3
	MOVWF       FARG_setServoAngle_id+0 
	MOVLW       0
	MOVWF       FARG_setServoAngle_id+1 
	...
	MOVWF       FARG_setServoAngle_angle+3 
	CALL        _setServoAngle+0, 0
;BracoRobotico.c,177 :: 		writeStr("write to gripper");
	MOVLW       ?lstr7_BracoRobotico+0
	MOVWF       FARG_writeStr_str+0 
	MOVLW       hi_addr(?lstr7_BracoRobotico+0)
	MOVWF       FARG_writeStr_str+1 
	CALL        _writeStr+0, 0
;BracoRobotico.c,179 :: 		break;
	GOTO        L_main9
;BracoRobotico.c,181 :: 		default:
L_main26:
;BracoRobotico.c,182 :: 		writeStr("");
...
;BracoRobotico.c,190 :: 		int parser(char* input, char* commands, float* params)
;BracoRobotico.c,192 :: 		int i = 0;
	CLRF        parser_i_L0+0 
	CLRF        parser_i_L0+1 
;BracoRobotico.c,193 :: 		char* token = strtok (input, ";");
...
;BracoRobotico.c,195 :: 		while (token && i < MAX_COMMANDS){
L_parser27:
...
L__parser45:
	...
	GOTO        L_parser28
L__parser39:
;BracoRobotico.c,196 :: 		commands[i] = token[1];
	...
	MOVF        POSTINC0+0, 0 
	MOVWF       POSTINC1+0 
;BracoRobotico.c,197 :: 		params[i++] = atof(&token[2]);
	MOVF        parser_i_L0+0, 0 
	MOVWF       R0 
	MOVF        parser_i_L0+1, 0 
	MOVWF       R1 
...
;BracoRobotico.c,198 :: 		token = strtok (0, ";");
...
;BracoRobotico.c,205 :: 		float limitAngle(float angle, int id)
;BracoRobotico.c,207 :: 		if(angle > servos[id].max)
	MOVLW       3
	MOVWF       R2 
...
L__limitAngle48:
	...
	BTFSC       STATUS+0, 2 
	GOTO        L_limitAngle31
;BracoRobotico.c,208 :: 		return servos[id].max;
	MOVLW       3
	MOVWF       R2 
	MOVF        FARG_limitAngle_id+0, 0 
	MOVWF       R0 
...
L_limitAngle31:
;BracoRobotico.c,209 :: 		else if(angle < servos[id].min)
	MOVLW       3
	MOVWF       R2 
	MOVF        FARG_limitAngle_id+0, 0 
	MOVWF       R0 
...
L__limitAngle52:
	...
	BTFSC       STATUS+0, 2 
	GOTO        L_limitAngle33
;BracoRobotico.c,210 :: 		return servos[id].min;
	MOVLW       3
	MOVWF       R2 
	MOVF        FARG_limitAngle_id+0, 0 
	MOVWF       R0 
...
L__limitAngle54:
	...
	GOTO        L_end_limitAngle
L_limitAngle33:
;BracoRobotico.c,211 :: 		return angle;
	MOVF        FARG_limitAngle_angle+0, 0 
	MOVWF       R0 
	MOVF        FARG_limitAngle_angle+1, 0 
	MOVWF       R1 
...
;BracoRobotico.c,215 :: 		void writeFloat(float f)
;BracoRobotico.c,218 :: 		FloatToStr(f, str);
...
;BracoRobotico.c,220 :: 		UART1_Write_Text(str);
	MOVLW       writeFloat_str_L0+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(writeFloat_str_L0+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;BracoRobotico.c,221 :: 		UART1_Write_Text("\r\n");
...
;BracoRobotico.c,225 :: 		void writeStr(char* str)
;BracoRobotico.c,227 :: 		UART1_Write_Text("\r\n");
	MOVLW       ?lstr13_BracoRobotico+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr13_BracoRobotico+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;BracoRobotico.c,228 :: 		UART1_Write_Text(str);
	MOVF        FARG_writeStr_str+0, 0 
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVF        FARG_writeStr_str+1, 0 
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;BracoRobotico.c,229 :: 		UART1_Write_Text("\r\n");
...
;BracoRobotico.c,233 :: 		void setServosPosition(int pos)
;BracoRobotico.c,240 :: 		it[BASE].stepSize = (anglesMatrix[pos][BASE] - it[BASE].beginAngle) / NUMBER_OF_STEPS;
	MOVLW       12
	MOVWF       R0 
	MOVLW       0
	MOVWF       R1 
	...
	MOVF        R3, 0 
	MOVWF       _it+7 
;BracoRobotico.c,241 :: 		it[SHOULDER].stepSize = (anglesMatrix[pos][SHOULDER] - it[SHOULDER].beginAngle) / NUMBER_OF_STEPS;
	MOVLW       4
	...
	MOVF        R3, 0 
	MOVWF       _it+15 
;BracoRobotico.c,242 :: 		it[ELBOW].stepSize = (anglesMatrix[pos][ELBOW] - it[ELBOW].beginAngle) / NUMBER_OF_STEPS;
	MOVLW       8
	ADDWF       FLOC__setServosPosition+0, 0 
	MOVWF       FSR0 
	MOVLW       0
	...
	MOVF        R3, 0 
	MOVWF       _it+23 
;BracoRobotico.c,244 :: 		for(i = 1; i <= NUMBER_OF_STEPS; i++)
	MOVLW       1
...
;BracoRobotico.c,246 :: 		ServoWrite(BASE, limitAngle(it[BASE].beginAngle + i*it[BASE].stepSize, BASE));
	MOVF        setServosPosition_i_L0+0, 0 
	MOVWF       R0 
...
;BracoRobotico.c,247 :: 		ServoWrite(SHOULDER, limitAngle(it[SHOULDER].beginAngle + i*it[SHOULDER].stepSize, SHOULDER));
	MOVF        setServosPosition_i_L0+0, 0 
	MOVWF       R0 
	MOVF        setServosPosition_i_L0+1, 0 
	MOVWF       R1 
	...
	CALL        _ServoWrite+0, 0
;BracoRobotico.c,248 :: 		ServoWrite(ELBOW, limitAngle(it[ELBOW].beginAngle + i*it[ELBOW].stepSize, ELBOW));
	MOVF        setServosPosition_i_L0+0, 0 
	MOVWF       R0 
	MOVF        setServosPosition_i_L0+1, 0 
	MOVWF       R1 
	...
	MOVWF       FARG_ServoWrite_srv_id+0 
	CALL        _ServoWrite+0, 0
;BracoRobotico.c,250 :: 		Delay_ms(200);
	MOVLW       3
	MOVWF       R11, 0
	MOVLW       8
	MOVWF       R12, 0
...
;BracoRobotico.c,253 :: 		it[BASE].beginAngle = it[BASE].beginAngle + NUMBER_OF_STEPS*it[BASE].stepSize;
	MOVLW       0
	MOVWF       R0 
	MOVLW       0
	MOVWF       R1 
	...
	MOVF        R3, 0 
	MOVWF       _it+3 
;BracoRobotico.c,254 :: 		it[SHOULDER].beginAngle = it[SHOULDER].beginAngle + NUMBER_OF_STEPS*it[SHOULDER].stepSize;
	MOVLW       0
	MOVWF       R0 
	MOVLW       0
	MOVWF       R1 
	...
	MOVF        R3, 0 
	MOVWF       _it+11 
;BracoRobotico.c,255 :: 		it[ELBOW].beginAngle = it[ELBOW].beginAngle + NUMBER_OF_STEPS*it[ELBOW].stepSize;
	MOVLW       0
	MOVWF       R0 
	MOVLW       0
	MOVWF       R1 
...
;BracoRobotico.c,260 :: 		void setServoAngle(int id, float angle)
;BracoRobotico.c,265 :: 		ServoWrite(id, limitAngle(angle, id));
